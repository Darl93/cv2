...
var person2 = Object.create({}, {
  name: {
    value: 'Ihar',
    enumerable: true,
    //модификатор enumerable по дефолту false
    writable: true,
    //модификатор writable по дефолту false
    configurable: true
  },
  lastName: {
    value: 'Maslakou',
...
var Animal = /*#__PURE__*/function () {
  //результатом вызова класса является объект
  function Animal(options) {
    _classCallCheck(this, Animal);

    //класс вызывает метод конструктор
...
var Cat = /*#__PURE__*/function (_Animal) {
  ...
  function Cat(options) {
    ...
    _this = _super.call(this, options); //вызов конструктора Animal
